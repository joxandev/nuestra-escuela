  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Nuestra Escuela' }
    ],
    link: [
      { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' },
      { rel: 'stylesheet', href:'https://cdnjs.cloudflare.com/ajax/libs/normalize/3.0.3/normalize.min.css'},

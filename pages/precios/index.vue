<template>
<section class="container article precios">
<h1><i class="fas fa-coins"></i> Precios Nuestra Escuela Leeds (NEL)</h1>
<h2>Curso escolar 2018 - 2019</h2>
<div class="table">
<table>
    <thead>
        <tr>
        <th>Grupo</th>
        <th class="alignCenter">Duración de cada sesión semana</th>
        <th class="alignCenter">Precio por niño y semana</th>
        <th class="alignCenter">Primer trimester <span>(De Septiembre a Diciembre 2018: 13 semanas)</span></th>
        <th class="alignCenter">Segundo trimester <span>(De Enero a Marzo 2019: 10 semanas)</span></th>
        <th class="alignCenter">Tercer trimester <span>(De Abril a Julio 2019: 10 semanas)</span></th>
    </tr>
 </thead>
 <tbody>
    ...
    <tr>
        <td class="bold">Preescolar </td>
        <td class="alignCenter">1 hora</td>
    ...
    <tr>
        <td class="bold">Preescolar avanzado </td>
        <td class="alignCenter">1.5 horas</td>
        <td class="alignCenter">£7.5</td>
        <td class="alignCenter">£97.5</td>
        <td class="alignCenter">£75</td>
        <td class="alignCenter">£75</td>
    </tr>
    <tr>
        <td class="bold">Junior</td>
        <td class="alignCenter">2 horas</td>
...
<ul>
    ...
    <li>No se aceptan pagos con cheques.</li>
</ul>
